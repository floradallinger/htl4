...
* wenn es mit @transactional anotiert ist startet der container (z.B. Quarkus) automatisch eine Transaktion

=== Optional Atributes
rollBackOn/dontRollbackOn kann man angeben welche Klasse [nicht] gespeichert werden sollen

https://quarkus.io/guides/hibernate-orm^[quarkus tutorial]
...
.tablescan
* einen scan einer tabelle, der die ganze tabelle logt
* einen Eintrag nach dem anderen full scan lesen

.learning path
* man kann sich anzeigen wie man in einer db sucht/abfragt


=== Für den Test
* einfaches datenbankmodell erstellen
* des lesen/speichern/updaten/...